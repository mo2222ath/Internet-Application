 ...
 * @author Moaaz Hasan
 */
@WebServlet(name = "reservationsCancle", urlPatterns = {"/reservationsCancle"})
public class reservationsCancle extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            OH = pro.getOHById(office_hoursList, OH_Id);
            OH.setReserved(0);
            ...
            out.println("Successful delete Reservation!");
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(reservationsCancle.class.getName()).log(Level.SEVERE, null, ex);
